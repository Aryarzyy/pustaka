...
confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['category']; ?> ?');" class="badge badge-danger"><i
			...
			<form action="<?= base_url('buku/kategori'); ?>" method="post">
				<div class="modal-body">
					<div class="form-group">
						<input type="text" name="category" id="category" placeholder="Masukkan Nama 
Kategori" class="form-control form-control-user">
					</div>
				</div>
