...
<head>
	...
	<link href="<?= base_url('assets/vendor/sbadmin-2/'); ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
		type="text/css">
...
<body id="page-top">
	...
	<script src="<?=
		base_url('assets/vendor/sbadmin-2/'); ?>vendor/jquery/jquery.min.js"></script>
	<script src="<?=
		base_url('assets/vendor/sbadmin-2/'); ?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
